...
\begin{itemize}
    \item The CPU issues commands to a device and continues doing other tasks. 
    \item I/O device generates an interrupt when the status changes, i.e., the data is ready
