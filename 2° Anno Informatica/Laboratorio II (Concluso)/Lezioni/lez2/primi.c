...
// NOTA: una vecchia caratteristica del C fa si che quando viene trovata una
// funzione senza un prototipo o che non riesce a trovare in nessuna librereia
// assume implicitamente che restituisca un intero
...
int main(int argc, char *argv[])
{
    ...
    if (a == NULL)
    { // Se a è null vuol dire che è avvenuto un errore ed non ha
      // allocato
        puts("Malloc fallita");
        exit(3);
    }
    ...
    // in caso abbiamo una sitazione con 57 elemeni inseriti l'array sarà di
    // dimensione 80 perchè 10*2 = 20*2 = 40*2 = 80, andiamo aora a ridurre la
    // tabella alla dimensione minima
