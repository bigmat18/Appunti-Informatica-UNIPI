...
\end{enumerate}
Per inventare un euristica ci sono alcune strategie, che aiutano appunto ad ottenre euristiche amissibili: Rilassamento del problema, 
...
\subsection{Euristiche da sottoproblemi}
\begin{figure}[h!]
    \centering
