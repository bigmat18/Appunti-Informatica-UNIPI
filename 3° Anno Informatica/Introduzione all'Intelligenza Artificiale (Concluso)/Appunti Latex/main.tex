...
\begin{document}
	...
	\end{center}
	\input{introduction}
	\input{agenti_intelligenti}
	\input{agenti_risolutori_problemi}
	\input{ricerca_euristica}
	\input{ricerca_locale.tex}
	\input{agenti_su_coscenza.tex}
	\input{calcolo_proposizionale.tex}
	\input{intro_ml.tex}
	\input{concept-learning.tex}
	\input{modelli-lineari.tex}
	\input{alberi-decisionali.tex}
	\input{validation.tex}
	\input{svm.tex}
	\input{recap-ML-model.tex}
\end{document}
